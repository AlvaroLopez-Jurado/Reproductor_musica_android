...
public class MenuGrid extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String string = b.getString("ALBUM");
        ...
        canciones_lista.setAdapter(new CancionesAdapter(this, null, string));
